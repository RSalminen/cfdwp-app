...
const TeacherViewerUI = ({vtkContext, customOptionsContext} : {vtkContext:React.MutableRefObject<IVTKContext | null>, customOptionsContext : React.MutableRefObject<ICustomOptions | null>}) => {
    
    const { notes, setNotes, visibleFields, simLoaded } = useContext(UIContext);
