...
const SearchBar = ({placeholder, onSearch} : {placeholder:string, onSearch:Function}) => {
    ...
    return (
        ...
        <form onSubmit={searchClicked} className="relative text-[13px] md:text-[16px]"> 
            ...
            <input maxLength={30} type="text" value={searchString} onChange={(e) => setSearchString(e.target.value)} className="h-10 md:h-12 pl-8 md:pl-10 pr-14 md:pr-24 rounded-lg z-0 focus:shadow focus:outline-none bg-gray-100" placeholder={placeholder} required minLength={2} />
