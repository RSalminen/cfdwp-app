    ...
    return (
        <div className="h-full w-full">
            <div className="absolute z-[9] top-1 right-2 flex items-center">
                <svg className="widgetHandle h-5 w-5 cursor-pointer" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20 9H4v2h16V9zM4 15h16v-2H4v2z"></path></svg>
