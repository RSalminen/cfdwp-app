          ...
          <div className="flex-grow flex flex-col space-y-6 items-center">
            ...
            <div className="fade-in-card w-fit sm:w-full bg-white shadow-md shadow-gray-600 rounded-md px-5 md:px-7 py-4 flex flex-col space-y-4 items-center sm:items-start">
              ...
              <div className="flex flex-wrap">
                <div className="flex flex-col h-36 w-60 sm:h-32 sm:w-52 rounded-md md:hover:cursor-pointer md:hover:-translate-y-2 transition-all">
                  ...
                  <div className="flex justify-center items-center px-2 h-[40%] border-x border-b rounded-b-md w-full overflow-hidden text-center">
                    <p className='text-[14px] inline-block break-words w-full font-medium'>Simulation 1</p>
                  </div>
                </div>
              </div>
            ...
            <div className="fade-in-card w-fit sm:w-full bg-white shadow-md shadow-gray-600 rounded-md px-5 md:px-7 py-4 flex flex-col space-y-4 items-center sm:items-start mb-5">
              ...
              <div className="flex flex-wrap">
                <div className="flex flex-col h-36 w-60 sm:h-32 sm:w-52 rounded-md md:hover:cursor-pointer md:hover:-translate-y-2 transition-all">
                  ...
                  <div className="flex justify-center items-center border-b border-x rounded-b-md px-2 h-[40%] w-full overflow-hidden text-center">
                    <p className='text-[14px] inline-block break-words w-full font-medium'>Collection 1</p>
                    <svg className="h-[14px] w-[14px] mt-0.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path></svg>
                  </div>
                </div>
              </div>
