...
const SingleCard = ({title, type}:{title:string, type:number}) => {
  return (
    <div className="flex flex-col h-36 w-60 sm:h-32 sm:w-52 m-2 rounded-md md:hover:cursor-pointer md:hover:-translate-y-2 transition-all">
...
const ShowMore = ({isVisible, showMoreClick, showLessClick}:{isVisible:boolean, showMoreClick:Function, showLessClick:Function}) => {
  ...
  return (
    <div className="w-full flex justify-center transition-all">
      {isVisible ?
      <div onClick={() => showMoreClick()} className="flex items-center text-center space-x-1 text-blue-900 hover:cursor-pointer">
      ...
      :
      <div onClick={() => showLessClick()} className="flex items-center text-center space-x-1 text-blue-900 hover:cursor-pointer">
