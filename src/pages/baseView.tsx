    ...
    <div className="fixed h-full w-full overflow-hidden">
      ...
      <div className="h-[calc(100%-60px)] transition-all overflow-y-hidden flex flex-col min-w-[300px] w-[20vw] right-0 top-[60px] bg-white absolute z-[2] bg-opacity-95 pl-4 pr-8 py-2">
        ...
        <div className="flex flex-col justify-between flex-1 h-0 pb-1">
          ...
          <div className="flex flex-col">
              {widgets.map((widget) => (
                <div className="flex flex-col space-y-2 border-2 p-2 bg-emerald-100 hover:cursor-pointer rounded-md" onClick={() => openWidget(widget)}>
      ...
      <div className={`${menuVisible ? "right-6" : "right-4"} absolute z-[7] transition-all top-[50vh] flex flex-col space-y-1.5`}>
        <div className={`${widgetOpen ? "bg-emerald-900" : "bg-black"} h-9 w-9 rounded-xl flex justify-center items-center hover:cursor-pointer`} onClick={() => widgetOpen ? setWidgetOpen(false) : openWidget(widgets[currentWidget])}>
        ...
        <div className={`${menuVisible ? "bg-emerald-900" : "bg-black"} h-9 w-9 rounded-xl flex justify-center items-center hover:cursor-pointer`} onClick={() => setMenuVisible(!menuVisible)}>
